...
import com.publish.shahar91.testingstuff.didyoufeelit.Event;
import com.publish.shahar91.testingstuff.didyoufeelit.Utils;
...
public final class QueryUtils {
    ...
    public static List<Earthquake> extractEarthquakes(String requestUrl) {
        ...
        try {
            ...
            JSONObject root = new JSONObject(requestUrl);
            JSONArray featuresArray = root.getJSONArray("features");

            for (int i = 0; i < featuresArray.length(); i++) {
                JSONObject currentEarthquake = featuresArray.getJSONObject(i);
                JSONObject prop = currentEarthquake.getJSONObject("properties");
