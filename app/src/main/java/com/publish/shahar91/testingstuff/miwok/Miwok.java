    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numbers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent openAct = new Intent(Miwok.this, NumbersActivity.class);
        ...
        family.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent openAct = new Intent(Miwok.this, FamilyActivity.class);
                startActivity(openAct);
            }
        });
        ...
        phrases.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent openAct = new Intent(Miwok.this, PhrasesActivity.class);
                startActivity(openAct);
            }
        });
        ...
        colors.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent openAct = new Intent(Miwok.this, ColorsActivity.class);
                startActivity(openAct);
            }
        });
    }
