...
public class PetProvider extends ContentProvider {
    ...
    static {
        ...
        /**
         * Sets the integer value for multiple row in table pets to 1. Notice that no
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        // uri: content://com.publish.shahar91.testingstuff/pets
    ...
    @Override
    public int update(@Nullable Uri uri, ContentValues contentValues, String selection,
    ...
    private int updatePet(@Nullable Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If 1 or more rows were updated, then modify all listeners that the data at the
        // given URI has changed
        if (rowsUpdated != 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
