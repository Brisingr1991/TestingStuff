...
import com.publish.shahar91.testingstuff.petsApp.data.PetDbHelper;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
     ...
     */
    private static final int EXIISTING_PET_LOADER = 0;
    ...
    private void showEmptyNameDialog(DialogInterface.OnClickListener discardButtonClickListener) {
        // Create an AlertDialog.Builder and set the message, and click listeners
        // for the positive and negative buttons on the dialog.
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("A pet needs a name in order to be saved in the app.");
        builder.setPositiveButton(R.string.discard, discardButtonClickListener);
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int i) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pets_editor);
        ...
        if (mCurrentPetUri == null) {
            ...
            getLoaderManager().initLoader(EXIISTING_PET_LOADER, null, this);
        }
            ...
            case R.id.action_save:
                ...
                if (mCurrentPetUri == null && TextUtils.isEmpty(nameString)
                    ...
                    if (nameString.isEmpty()) {
                        ...
                        showEmptyNameDialog(ButtonClickListener);
                    } else {
                        savePet(nameString, breedString, weightString);
                        // Exit activity
                        finish();
                    }
                }
    ...
    private void savePet(String nameString, String breedString, String weightString) {
        ...
        if (mCurrentPetUri == null) {
            ...
            if (newUri == null) {
                // If the new content URI is null, then there was an error with the insertion.
                Toast.makeText(this, "Error adding new pet.", Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the insertion was successful and we can display a toast
                Toast.makeText(this, "New pet has been added.", Toast.LENGTH_SHORT).show();
            }
        } else {
            // Otherwise this is an EXISTING pet, so update the pet with content URI: mCurrentPetUri
            // and pass in the new ContentValues. Pass in null for the selection and selectionArgs
            ...
            if (rowsAffected == 0) {
                ...
                // Otherwise, the insertion was successful and we can display a toast
                Toast.makeText(this, "Pet has been updated.", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            // And extract out the value from the Cursor for the given column index
