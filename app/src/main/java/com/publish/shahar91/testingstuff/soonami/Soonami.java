package com.publish.shahar91.testingstuff.soonami;
...
public class Soonami extends AppCompatActivity {

    /**
     * Tag for the log messages
     */
    public static final String LOG_TAG = Soonami.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soonami_activity);
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    Log.e(LOG_TAG, "responseCode is not 200: " + urlConnection.getResponseCode());
                }
            } catch (IOException e) {
                Log.e(LOG_TAG, "Getting IOException", e);
            } finally {
